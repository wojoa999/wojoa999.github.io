...
labels:
  ...
  - Vercel
  - pgAdmin
summary: "Final project for software engineering (ICS 314) course to design a web application. This web application stores a database of usable templates for the ITS department to utilize."
---
...
* **Administrative Tool:** pgAdmin is utilized as a tool to interact with the database, allowing for quick access to check, add, and edit the tables.    
