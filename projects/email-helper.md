...
labels:
  ...
  - Vercel
  - pgAdmin
summary: "Final project for software engineering (ICS 314) course to design a web application. The application is a stores a database of useable templates for the ITS department to utilize."
---
